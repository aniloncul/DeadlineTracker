    ...
    var body: some View {
        NavigationView {
            ...
            VStack {
                ...
                ScrollView() {
                    VStack(spacing: 24){
                        ForEach(filteredItems.sorted { $0.deadlineDate < $1.deadlineDate }) { item in
                            ...
                            DeadlineListCell(title: item.deadlineName,
                                             ...
                                             maxTimeInterval: totalSeconds, timeInterval: formattedTime, deadlineHour: item.deadlineDate.formatted(.dateTime.hour().minute())
                            )
            ...
            }.navigationTitle(Date().formatted(.dateTime.day().weekday().month().year()))
                    .padding(12)
